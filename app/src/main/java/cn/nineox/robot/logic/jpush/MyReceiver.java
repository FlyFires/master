package cn.nineox.robot.logic.jpush;
...
//			}
    ...
    private void startP2P(Context context, Bundle bundle) throws JSONException {
        ...
        Log.d(TAG, "[MyReceiver] notification - " + notification + ", extras: " + extra);

        JSONObject jsonObject = new JSONObject(extra);

        Bundle bundle1 = new Bundle();
        bundle1.putString("userid", APPDataPersistent.getInstance().getLoginInfoBean().getP2PUid());
        ...
        Intent i = new Intent(context, RobotPreviewActivity.class);
        i.putExtras(bundle1);
        //i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        context.startActivity(i);
