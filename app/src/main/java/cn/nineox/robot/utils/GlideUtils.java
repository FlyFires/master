...
public class GlideUtils implements cn.finalteam.galleryfinal.ImageLoader{
    ...
    public static void  displayImageView(ImageView mImageView,String imageUrl){
        Glide.with(mImageView.getContext()).load(imageUrl).transform(new GlideCircleTransform(mImageView.getContext())).into(mImageView);
    }
    ...
    public static void displayCircleImageView(ImageView mImageView,String imageUrl,Drawable error){
        Glide.with(PluginAPP.getInstance()).load(imageUrl).error(error).transform(new GlideCircleTransform(mImageView.getContext())).into(mImageView);
    }
