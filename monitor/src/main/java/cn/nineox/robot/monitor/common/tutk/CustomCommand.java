...
public class CustomCommand {
	...
	public static Integer toCotrollCmd(int data){
		int cmd = 0;
		switch (data){
			case FEET_MOTOR_LEFT:
				cmd = Integer.valueOf(0);
				break;
			case FEET_MOTOR_RIGHT:
                cmd = Integer.valueOf(1);
				break;
			case FEET_MOTOR_FORWARD:
                cmd = Integer.valueOf(2);
				break;
			case FEET_MOTOR_BACK:
                cmd = Integer.valueOf(3);
				break;
			case FEET_MOTOR_STOP:
                cmd = Integer.valueOf(4);
				break;
			default:
                cmd = Integer.valueOf(4);
				break;
