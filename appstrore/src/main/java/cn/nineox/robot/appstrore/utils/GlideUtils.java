...
public class GlideUtils{
    ...
    public static void displayImageView(ImageView mImageView,String imageUrl){Glide.with(mImageView.getContext()).load(imageUrl).transform(new GlideRoundTransform(mImageView.getContext(),86)).into(mImageView);
    }
