...
import cn.nineox.robot.appstrore.MainActivity;
...
public class TasksManager {
    ...
    private void registerServiceConnectionListener(final WeakReference<AppListFragment>
    ...
    public void onCreate(final WeakReference<AppListFragment> activityWeakReference) {
    ...
    public TasksManagerModel addTask(final String url, final String path, final String appName) {
        ...
        final TasksManagerModel newModel = dbController.addTask(url, path, appName);
        if (newModel != null) {
