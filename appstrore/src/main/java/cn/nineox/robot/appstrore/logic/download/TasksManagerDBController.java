...
public class TasksManagerDBController {
    ...
    public TasksManagerDBController() {
        TasksManagerDBOpenHelper openHelper = new TasksManagerDBOpenHelper(PluginAPP.getInstance());
    ...
    public TasksManagerModel addTask(final String url, final String path, String appName) {
